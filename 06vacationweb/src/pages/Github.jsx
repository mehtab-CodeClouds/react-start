    ...
    <section className="py-10">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="grid grid-cols-2 gap-8 items-center">
          <div className="relative w-full max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <label className="inline-flex items-center cursor-pointer absolute top-6 right-6">
              <input
                type="checkbox"
                value=""
